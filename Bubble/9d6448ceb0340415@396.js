...
d3.keys(people2).map(function(d) {
  ...
  main.variable(observer("chart")).define("chart", ["d3","width","height","nodes","groups","forceCluster","forceCollide","nodes2","groups2",], function(d3,width,height,nodes,groups,forceCluster,forceCollide, nodes2, groups2)
{
  // Variables.
  var time_so_far = 0;
  // The SVG object.
